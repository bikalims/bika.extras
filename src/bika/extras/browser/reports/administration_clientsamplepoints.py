...
from bika.lims.browser.reports.administration_arsnotinvoiced import (
    Report as RA,
)
            ...
            dw.writerow(
                {
                    ...
                    "Sample Point Name": safe_unicode(row[2]["value"]).encode(
                        t
                    ),
                    "Sample Point Description": safe_unicode(
                        row[3]["value"]
                    ).encode(t),
