...
#
#  $ bin/test -s bika.extras -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src bika.extras.testing.BIKA_EXTRAS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/bika/extras/tests/robot/test_example.robot
#
